...
\textbf{编号约定：}原图顶点统一使用 $1$-based 编号 $1,2,\ldots,n$，所有接口中的区间均为 $1$-based 闭区间 $[l,r]$。不要直接用原图编号访问 \texttt{g}；原图点 $u$ 在扩展图中的真实编号是 \texttt{id(u)}。扩展图、线段树结点和中转点的编号仅供结构体内部使用，不属于原图的 base 约定。
